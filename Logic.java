...
public class Logic 
    ...
    public static double circleArea(double radius) {
        ...
        cArea = Math.PI * Math.pow(radius,2);
        return  cArea;
    }
    ...
    public static double rightTrianglePerimeter(double base, double height) {
        ...
        rtPerimeter = base + height + (Math.sqrt((base * base) + (height * height)));
        return rtPerimeter;
    }
    ...
    public static double boxSurfaceArea(double length, double width, double depth) {
        ...
        bsArea = (2 * length * depth) + (2 * width * depth) + (2 * length * width);
        return bsArea;
    }
    ...
    public static double sphereSurfaceArea(double radius) {
        ...
        ssArea = 4 * Math.PI * Math.pow(radius,2);
        return ssArea;
    }
}
